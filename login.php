      ...
      <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
        ...
        <form action="getquery.php" method="post">
          ...
          <div class="text-center mt-4 pt-2" >
            <input type="submit"  name="loginbtn" id="loginbtn" class="btn btn-primary btn-lg" value="Sign In" style="padding-left: 2.5rem; padding-right: 2.5rem;">
          </div>
