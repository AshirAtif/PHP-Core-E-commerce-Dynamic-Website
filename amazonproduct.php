...
<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="true">
  <div class="container-fluid py-1 px-3">
    ...
    <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
     ...
     <div id="content">
     <form method="POST" action="amzupload.php" enctype="multipart/form-data">
     <div class="form-group">
             <input class="form-control" type="text" name="name" value="" placeholder="Enter product Amazon name" />
         </div>
         <div class="form-group">
             <input class="form-control" type="text" name="code"  placeholder="Enter product Sku" />
         </div>
         <div class="form-group">
         ...
         <div class="form-group">
             <input class="form-control" type="file" name="hoverfile" value="" />
         </div>
         <div class="form-group">
             <button class="btn btn-danger" type="submit" name="upload">Submit</button>
         </div>
     </form>
 </div>
