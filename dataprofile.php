                ...
                <table class="table">
                     ...
                     <tbody >
                        ...
                        <tr>                                                                        
                            ...
                            <td class="tbody" style="width: 15%;"><?php echo $row['name']; ?></td>
                            <td style="width: 15%;"><?php echo $row['sname']; ?></td>
                            <td style="width: 25%;"><?php echo $row['number']; ?></td>
                            <td style="width: 35%;"><?php echo $row['address']; ?></td>
