        ...
        <div class="row">
            <div class="col-12">
                <ol class="breadcrumb d-flex align-items-center">
                    ...
                    <li class="breadcrumb-item active">Water Bottol</li>
                </ol>
                <!-- btn -->
                ...
                <div class="row">
                        ...
                        <div class="single_product_thumb">
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                ...
                                <ol class="carousel-indicators">
                                    <li class="active" data-target="#product_details_slider" data-slide-to="0" style="background-image: url(bluebottol1.jpg); background-size: cover;">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="1" style="background-image: url(bottol2.jpg); 	background-size: cover;">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="2" style="background-image: url(bluebottol.jpg); 	background-size: cover;">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="3" style="background-image: url(bottol4.jpg); 	background-size: cover;">
                                    </li>
                                </ol>

                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <a class="gallery_img" href="bluebottol.jpg">
                                        <img class="d-block w-100" style="height:650px;" src="bluebottol.jpg" alt="First slide">
                                    </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="bottol2.jpg">
                                        <img class="d-block w-100" style="height:650px;" src="bottol2.jpg" alt="Second slide">
                                    </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="bluebottol1.jpg">
                                        <img class="d-block w-100" style="height:650px;" src="bluebottol1.jpg" alt="Third slide">
                                    </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="bottol4.jpg">
                                        <img class="d-block w-100" style="height:650px;" src="bottol4.jpg" alt="Fourth slide">
                                    </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="single_product_desc">
                            ...
                            <h4 class="title"><a href="#">Plastic Water Bottol</a></h4>

                            <h4 class="price">39.99 AED</h4>
 ...
 <tbody>
   ...
   <tr>
    ...
    <tr>
     ...
     <td>12 x 12 x 12 cm; 110 Grams</td>
